...
open class KaptAnnotationProcessorOptions() : KaptArguments {
    @Suppress("UNUSED_PARAMETER")
    @Deprecated(
        message = "This constructor with parameters is scheduled for removal in Kotlin 2.3. Consider migrating to the constructor without parameters.",
    ...
    @Deprecated(
        message = "This function with Any parameters is scheduled for removal in Kotlin 2.3. Consider migrating to the function with String parameters.",
    ...
    @Deprecated("Scheduled for removal in Kotlin 2.3")
...
open class KaptJavacOptionsDelegate : KaptJavacOption {
    ...
    @Deprecated(
        message = "This function with Any parameter is scheduled for removal in Kotlin 2.3. Consider migrating to the function with String parameter.",
