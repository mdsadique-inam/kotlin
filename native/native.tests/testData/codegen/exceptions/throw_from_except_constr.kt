...
fun box(): String {
    try {
        ...
        val goldValues = arrayOf(
                "kfun:codegen.exceptions.throw_from_except_constr.CustomException#constrException(){}",
                "kfun:codegen.exceptions.throw_from_except_constr#exception(){}",
                "kfun:codegen.exceptions.throw_from_except_constr#box(){}kotlin.String",
        )
